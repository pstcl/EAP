								...
								<c:when test="${passwordChangeDue}">
									<span> <i class="fa fa-warning"
										style="font-size: 18px; color: red;"><i
											class="fas fa-exclamation-circle"></i>Please Change Your Password</i>
									</span>
								</c:when>
								<c:otherwise>
							Change Password
			...
			<div class="col-md-9 float-left col px-5 pl-md-2 pt-2 main">
				...
				<div class="row" style="align-items: center;">
					...
					<sec:authorize
						...
						<div class="form-control col-sm-4">
							<a class="nav-link"
								href="javascript:window.location='pendingRepoFiles?month=11&year=2018'">
								<div class="card" style="align-items: center;"
									data-toggle="tooltip" data-placement="top"
					...
					<sec:authorize
						...
						<div class="form-control col-sm-4">
							...
							<a href="#" role="button" class="nav-link btn popovers"
								...
								data-content="<a href='getLossReport?month=9&year=2018' title='Oct'>October,2018</a>
								<br>
								<a href='getLossReport?month=10&year=2018' title='Nov'>November,2018</a><br>
								<a href='getLossReport?month=11&year=2018' title='Jan'>December,2018</a>"
						...
						<div class="form-control col-sm-4">
							...
							<a href="#" role="button" class="nav-link btn popovers"
								data-toggle="popover" title=""
								data-content="<a href='getPendingLossReportLocation?month=9&year=2018' title='Oct'>October,2018</a>
								<br>
								<a href='getPendingLossReportLocation?month=10&year=2018' title='Nov'>November,2018</a>
								<br>
					...
					<sec:authorize
						...
						<sec:authorize access="hasAnyRole('ROLE_SS_AE','ROLE_SR_XEN')">
							...
							<div class="form-control col-sm-4">
								<a class="nav-link"
									href="javascript:window.location='substationHome?month=12&year=2018'">
									<div class="card" style="align-items: center;"
										data-toggle="tooltip" data-placement="top"
						...
						<div class="form-control col-sm-4">
							...
							<a href="#" role="button" class="nav-link btn popovers"
								data-toggle="popover" title=""
								data-content="<a href='getPendingLossReportLocationPM?month=9&year=2018' title='Oct'>October,2018</a>
								<br>
								<a href='getPendingLossReportLocationPM?month=10&year=2018' title='Nov'>November,2018</a>
								<br>
