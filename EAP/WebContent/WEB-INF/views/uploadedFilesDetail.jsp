			...
			<ul class="navbar-nav  mr-auto">
				...
				<div class="dropdown nav-link">
					...
					<ul class="dropdown-menu">
						<li><a class="nav-link"
							href="javascript:window.location='filesInRepoS?month=10&year=2018'"><span
								class="glyphicon glyphicon-plus"></span>October,2018</a></li>
						<li><a class="nav-link"
							href="javascript:window.location='filesInRepoS?month=11&year=2018'"><span
								class="glyphicon glyphicon-plus"></span>November,2018</a></li>
				...
				<div class="dropdown nav-link">
					...
					<ul class="dropdown-menu">
						<li><a class="nav-link"
							href="javascript:window.location='pendingRepoFiles?month=10&year=2018'"><span
								class="glyphicon glyphicon-plus"></span>October,2018</a></li>
						<li><a class="nav-link"
							href="javascript:window.location='pendingRepoFiles?month=11&year=2018'"><span
								class="glyphicon glyphicon-plus"></span>November,2018</a></li>
					<li><a class="nav-link"
				...
				<sec:authorize access="hasRole('ROLE_SLDC_ADMIN')">
					...
					<div class="dropdown nav-link">
						...
						<ul class="dropdown-menu">
							...
							<li><a class="nav-link"
								href="javascript:window.location='corruptRepoFiles?month=10&year=2018'"><span
									class="glyphicon glyphicon-plus"></span>October,2018</a></li>
							<li><a class="nav-link"
								href="javascript:window.location='corruptRepoFiles?month=11&year=2018'"><span
									class="glyphicon glyphicon-plus"></span>November,2018</a></li>
					...
					<div class="dropdown nav-link">
						...
						<ul class="dropdown-menu">
							...
							<li><a class="nav-link"
								href="javascript:window.location='processCorruptRepoFiles?month=10&year=2018'"><span
									class="glyphicon glyphicon-plus"></span>October,2018</a></li>
							<li><a class="nav-link"
								href="javascript:window.location='processCorruptRepoFiles?month=11&year=2018'"><span
									class="glyphicon glyphicon-plus"></span>November,2018</a></li>
					...
					<div class="dropdown nav-link">
						...
						<ul class="dropdown-menu">
							<li><a class="nav-link"
								href="<c:url value='/processRepoFiles?month=10&year=2018' />"><span
									class="glyphicon glyphicon-plus"></span>October,2018</a></li>
							<li><a class="nav-link"
								href="<c:url value='/processRepoFiles?month=11&year=2018' />"><span
									class="glyphicon glyphicon-plus"></span>November,2018</a></li>
